...
namespace CSharp_Lab4
{
    class Ereaser : Tool
    {
        public Ereaser(Panel board, Button button, float size, Color color)
        {
            _board = board;
        ...
        public override void Paint()
        {
            ...
            _graph.DrawEllipse(new Pen(Color.White, 5 * _brushSize), _currentMousePos.x, _currentMousePos.y, 50, 50);
        }
    }
}
